...
###############################################################################
"""Fill in the silded comment listing for users.

This listing is stored in get_silded_user_comments and seen on
/user/<username>/silded.
...
from v1.lib.db.queries import get_silded_user_comments
    ...
    while date > earliest_date:
        ...
        for silding in sildings:
            ...
            if fullname in comments and fullname not in already_seen:
                ...
                m.insert(get_silded_user_comments(thing.author_id),
                         [silding_object])
