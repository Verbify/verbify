...
from v1.lib.utils import to36, weighted_lottery
from v1.models.traffic import (
    Session,
    TargetedImpressionsByCodename,
    PageviewsBySubverbifyAndPath,
)
from v1.models.bidding import PromotionWeights
...
def get_campaign_pageviews(date, sr_name=''):
    ...
    q = (Session.query(traffic_cls.codename,
            ...
            .filter(traffic_cls.subverbify == sr_name)
...
def get_frontpage_pageviews(date):
    ...
    traffic_cls = PageviewsBySubverbifyAndPath
