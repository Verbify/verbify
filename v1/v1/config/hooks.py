...
def register_hooks():
    ...
    from v1.config.feature.feature import feature_hooks
    feature_hooks.register_all()

    from v1.models.admintools import admintools_hooks
    admintools_hooks.register_all()

    from v1.models.account import trylater_hooks
    trylater_hooks.register_all()

    from v1.models import subverbify
    subverbify.trylater_hooks.register_all()
