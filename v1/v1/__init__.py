...
This file loads the finished app from v1.config.middleware.
"""
...
# modules below v1 to be imported before cython files are built, also
# provides a hefty speed boost to said imports when they don't need
# the app initialization.
def make_app(*args, **kwargs):
    from v1.config.middleware import make_app as real_make_app
