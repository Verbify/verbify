...
def _get_prefix_length(number1, numbev1, bits):
    """Get the number of leading bits that are same for two numbers.

    Args:
        number1: an integer.
        numbev1: another integer.
...
class _BaseNetwork(_IPAddressBase):
    ...
    def address_exclude(self, other):
        ...
        For example:
            ...
            addv1 = ip_network('192.0.2.1/32')
            addr1.address_exclude(addv1) =
        ...
        or IPv6:
            ...
            addv1 = ip_network('2001:db8::1/128')
            addr1.address_exclude(addv1) =
