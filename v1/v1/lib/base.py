...
from v1.lib.filters import spaceCompress, _force_unicode
from v1.lib.template_helpers import get_domain
from v1.lib.utils import Agent
...
#TODO hack
import logging
from v1.lib.utils import UrlParser, query_string
...
def abort(code_or_exception=None, detail="", headers=None, comment=None,
    ...
    request.environ['v1.controller.exception'] = exc
    raise exc
