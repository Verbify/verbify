...
from v1.models import Comment, LinkListing, Link, Message, PromotedLink, Report
from v1.models import IDBuilder, Thing
...
class PrintableButtons(Styled):
    ...
    def __init__(self, style, thing,
                 ...
                 show_givesodium=False, show_sticky_comment=False,
                 **kw):
...
class LinkButtons(PrintableButtons):
    def __init__(self, thing, comments = True, delete = True, report = True):
        ...
        show_share = ((c.user_is_loggedin or not g.read_only_mode) and
                      not thing.subverbify.quarantine and
        ...
        show_givesodium = thing.can_sild and (c.permalink_page or c.profilepage)
...
class MessageButtons(PrintableButtons):
    def __init__(self, thing, delete = False, report = True):
        ...
        if was_comment:
            ...
            if link.is_archived(thing.subverbify) or link.locked:
                can_reply = False
