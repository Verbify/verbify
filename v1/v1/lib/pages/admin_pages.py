...
from v1.lib.pages import LinkInfoBar, Verbify
...
class AdminPage(Verbify):
    ...
    def __init__(self, nav_menus = None, *a, **kw):
        Verbify.__init__(self, nav_menus = nav_menus, *a, **kw)
...
class AdminNotesSidebar(Templated):
    EMPTY_MESSAGE = {
        ...
        "subverbify": N_("No notes for this subverbify"),
