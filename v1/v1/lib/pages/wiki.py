...
from v1.lib.pages.pages import (
    AutoModeratorConfig,
    RawCode,
    Verbify,
...
from v1.lib.menus import PageNameNav
from v1.lib.validator.wiki import this_may_revise
from v1.lib.filters import wikimarkdown, safemarkdown
...
class WikiBasePage(Verbify):
    ...
    def __init__(self, content, page=None, may_revise=False,
        ...
        Verbify.__init__(self, extra_js_config={'wiki_page': page}, 
...
class WikiNotFound(WikiBasePage):
    def __init__(self, page, **context):
        ...
        context['alert'] = _("page %s does not exist in this subverbify") % page
...
class WikiListing(WikiBasePage):
    def __init__(self, pages, linear_pages, **context):
        ...
        description = [_("Below is a list of pages in this wiki visible to you in this subverbify.")]
