...
from v1.config import queues
import v1.lib.amqp
from v1.lib.baseplate_integration import V1BaseplateObserver
from v1.lib.cache import (
    CacheChain,
    CL_ONE,
    CL_QUORUM,
    CMemcache,
...
from v1.lib.configparse import ConfigValue, ConfigValueParser
from v1.lib.contrib import ipaddress
from v1.lib.contrib.activity_thrift import ActivityService
from v1.lib.contrib.activity_thrift.ttypes import ActivityInfo
from v1.lib.eventcollector import EventQueue
from v1.lib.lock import make_lock_factory
from v1.lib.manager import db_manager
from v1.lib.plugin import PluginLoader
from v1.lib.providers import select_provider
from v1.lib.stats import (
    CacheStats,
    StaleCacheStats,
    Stats,
    StatsCollectingConnectionPool,
)
from v1.lib.translation import get_active_langs, I18N_PATH
from v1.lib.utils import config_sodium_price, thread_dump
from v1.lib.zookeeper import (
...
class Globals(object):
    ...
    live_config_spec = {
        ...
        ConfigValue.str: [
            'listing_chooser_sodium_multi',
            'listing_chooser_explore_sr',
        ],
        ConfigValue.messages: [
            'welcomebar_messages',
            'sidebar_message',
            'sodium_sidebar_message',
        ],
        ConfigValue.dict(ConfigValue.str, ConfigValue.int): [
            'ticket_groups',
            'ticket_user_fields', 
    ...
    def __init__(self, config, global_conf, app_conf, paths, **extra):
        ...
        self.baseplate.register(V1BaseplateObserver())
    ...
    def setup(self):
        ...
        self.verbify_host = socket.gethostname()
        self.verbify_pid  = os.getpid()
        ...
        self.versions = {}
        v1_root = os.path.dirname(os.path.dirname(self.paths["root"]))
        v1_gitdir = os.path.join(v1_root, ".git")
        self.short_version = self.record_repo_version("v1", v1_gitdir)
