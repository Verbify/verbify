...
from v1.lib.mr_tools._mr_tools import mr_map, mr_reduce, format_dataspec
from v1.lib.mr_tools._mr_tools import stdin, emit
...
def test():
    from v1.lib.mr_tools._mr_tools import keyiter
