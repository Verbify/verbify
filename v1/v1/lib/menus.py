...
from v1.lib.strings import StringHandler, plurals
from v1.lib.utils import  class_property, query_string, timeago
from v1.lib.wrapped import Styled
...
menu =   MenuHandler(hot          = _('hot'),
                     ...
                     sodium         = _('verbify sodium'),
                     verbifys      = _('subverbifys'),
                     rules        = _('site rules'),
                     jobs         = _('jobs'),
                     ...
                     community_settings = _("subverbify settings"),
...
class SubverbifyButton(NavButton):
    from v1.models.subverbify import Frontpage, Mod, All, Random, RandomSubscription
    ...
    # TRANSLATORS: This refers to the user's front page
                      ...
                      All: N_("all"),
                      Random: N_("random"),
    # TRANSLATORS: Sodium feature, "myrandom", a random subverbify from your subscriptions
...
class PageNameNav(Styled):
    ...
    subverbify name, the page name, etc.)"""
    pass
...
class CommentSortMenu(SortMenu):
    ...
    # that is, do not check the subverbify for a suggested sort, either.
...
class SubverbifySearchSortMenu(SortMenu):
    """Sort menu for subverbify search pages."""
    _default = 'relevance'
