...
from v1.config.paths import get_built_statics_path
from v1.lib.permissions import ModeratorPermissionSet
from v1.lib.plugin import PluginLoader
from v1.lib.static import locate_static_file
from v1.lib.translation import (
...
class DataSource(Source):
    ...
    def use(self):
        from v1.lib.filters import SC_OFF, SC_ON, websafe_json
...
class LocalizedModule(Module):
    ...
    def build(self, minifier):
        ...
        with open(self.destination_path) as f:
            verbify_source = f.read()

        localized_appendices = self.localized_appendices
        msgids = extract_javascript_msgids(verbify_source)
        if msgids:
    ...
    def use(self, **kwargs):
        ...
        from v1.lib.template_helpers import static
        from v1.lib.filters import SC_OFF, SC_ON
...
module["verbify-embed-base"] = Module("verbify-embed-base.js",
    "lib/es5-shim.js",
    "lib/json2.js",
    "base.js",
    "uuid.js",
...
module["verbify-embed"] = Module("verbify-embed.js",
    module["verbify-embed-base"],
    "embed/embed.js",
)
...
module["verbify-init-base"] = LocalizedModule("verbify-init-base.js",
    "lib/modernizr.js",
    "lib/json2.js",
...
module["verbify-init-legacy"] = LocalizedModule("verbify-init-legacy.js",
    "lib/html5shiv.js",
    "lib/jquery-1.11.1.js",
    "lib/es5-shim.js",
    "lib/es5-sham.js",
    module["verbify-init-base"],
    wrap=catch_errors,
)

module["verbify-init"] = LocalizedModule("verbify-init.js",
    "lib/jquery-2.1.1.js",
    "lib/es5-shim.js",
    module["verbify-init-base"],
    wrap=catch_errors,
...
module["verbify"] = LocalizedModule("verbify.js",
    "lib/jquery.url.js",
    ...
    wrap=catch_errors,
    filter_module=module["verbify-init-base"],
)

module["modtools"] = Module("modtools.js",
    "errors.js",
    "models/validators.js",
    "models/subverbify-rule.js",
    "edit-subverbify-rules.js",
    wrap=catch_errors,
)
...
# browsers that choke on verbify.js
