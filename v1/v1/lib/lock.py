...
from v1.lib.utils import simple_traceback

# thread-local storage for detection of recursive locks
locks = local()

verbify_host = socket.gethostname()
verbify_pid  = os.getpid()
...
class MemcacheLock(object):
    ...
    def acquire(self):
        ...
        self.nonce = (verbify_host, verbify_pid, simple_traceback(limit=7))
