...
from v1.lib import rising
from v1.lib.db import operators, tdb_cassandra
from v1.lib.pages import ExploreItem
from v1.lib.normalized_hot import normalized_hot
from v1.lib.utils import roundrobin, tup, to36
from v1.models import Link, Subverbify
from v1.models.builder import CommentBuilder
from v1.models.listing import NestedListing
from v1.models.recommend import (
    AccountSRPrefs,
    AccountSRFeedback,
)
...
def get_discovery_srid36s():
    ...
    srs = Subverbify._by_name(g.live_config['discovery_srs'])
...
def is_visible(sr):
    ...
    return (
        sr.type not in Subverbify.private_types and
        not sr._spam and
        sr.discoverable
    )
...
class SRRecommendation(tdb_cassandra.View):
    ...
    # N runs didn't generate recommendations for a given subverbify
