...
from v1.lib.filters import websafe
from v1.lib.generate_strings import funny_translatable_strings
from v1.lib.translation import set_lang
...
string_dict = dict(
    ...
    multiple_submitted = _("that link has been submitted to multiple subverbifys. you can try to [submit it again](%s)."),

    user_deactivated = _("your account has been deactivated, but we won't judge you for it."),

    oauth_login_msg = _(
        "Log in or sign up to connect your verbify account with %(app)s."),
    ...
    friends = _('to view verbify with only submissions from your friends, use [verbify.com/r/friends](%s)'),

    sr_created = _('your subverbify has been created'),

    more_info_link = _("visit [%(link)s](%(link)s) for more information"),

    sr_messages = dict(
        empty =  _('you have not subscribed to any subverbifys.'),
        subscriber =  _('below are the subverbifys you have subscribed to.'),
        contributor =  _('below are the subverbifys that you are an approved submitter on.'),
        moderator = _('below are the subverbifys that you have moderator access to.')
        ),

    sr_subscribe =  _('click the `subscribe` or `unsubscribe` buttons to choose which subverbifys appear on your front page.'),

    searching_a_verbify = _('you\'re searching within the [%(verbify_name)s](%(verbify_link)s) subverbify. '+
                           'you can also search within [all subverbifys](%(all_verbifys_link)s)'),

    permalink_title = _("%(author)s comments on %(title)s"),
    link_info_title = _("%(title)s : %(site)s"),
    link_info_og_description = _("%(score)s points and %(num_comments)s comments so far on verbify"),
    ...
    formatting_help_info = _('verbify uses a slightly-customized version of [Markdown](http://daringfireball.net/projects/markdown/syntax) for formatting. See below for some basics, or check [the commenting wiki page](/wiki/commenting) for more detailed help and solutions to common issues.'),
    read_only_msg = _("Verbify is in \"emergency read-only mode\" right now. :( You won't be able to log in. We're sorry and are working frantically to fix the problem."),
    heavy_load_msg = _("this page is temporarily in read-only mode due to heavy traffic."),
    in_perma_timeout_msg = _("Your account has been permanently [suspended](https://verbify.zendesk.com/hc/en-us/articles/205687686) from Verbify."),
    in_temp_timeout_msg = _("Your account has been [suspended](https://verbify.zendesk.com/hc/en-us/articles/205687686) from Verbify for %(days)s."),
    sodium_benefits_msg = "verbify sodium is our premium membership program. It grants you access to [extra features](https://www.verbify.com/sodium/about) to improve your verbify experience. It also makes you really quite dapper. If you have questions about your sodium, please visit /r/sodiumbenefits.",
    ...
    over_comment_limit = _("Sorry, the maximum number of comments is %(max)d. (However, if you subscribe to verbify sodium, it goes up to %(sodiummax)d.)"),
    over_comment_limit_sodium = _("Sorry, the maximum number of comments is %d."),
    youve_got_sodium = "%(sender)s just gifted you %(amount)s of verbify sodium!",
    giftsodium_note = "Here's a note that was included:\n\n----\n\n",
    youve_been_silded_comment = "%(sender)s liked [your comment](%(url)s) so much that they silded it, giving you verbify sodium.\n\n",
    youve_been_silded_link = "%(sender)s liked [your submission](%(url)s) so much that they silded it, giving you verbify sodium.\n\n",
    respond_to_anonymous_silder = "Want to say thanks to your mysterious benefactor? Reply to this message. You will find out their username if they choose to reply back.",
    unsupported_respond_to_silder = "Sorry, replying directly to your mysterious benefactor is not yet supported for this silding.",
    anonymous_silder_warning = _("***WARNING: Responding to this message will reveal your username to the sildee.***\n\n"),
    sodium_claimed_code = _("Thanks for claiming a verbify sodium code.\n\n"),
    sodium_summary_autorenew_monthly = _("You're about to set up an ongoing, autorenewing subscription to verbify sodium for yourself (%(user)s). \n\nYou'll pay **%(price)s** for this, **monthly**. \n\n>This subscription will renew automatically each month until you cancel. You may cancel at any time. If you cancel, you will not be billed for any additional months of service, and service will continue until the end of the billing period. If you cancel, you will not receive a refund for any service already paid for. Receipts will be delivered via private message in your account."),
    sodium_summary_autorenew_yearly = _("You're about to set up an ongoing, autorenewing subscription to verbify sodium for yourself (%(user)s). \n\nYou'll pay **%(price)s** for this, **yearly**. \n\n>This subscription will renew automatically each year until you cancel. You may cancel at any time. If you cancel, you will not be billed for any additional years of service, and service will continue until the end of the billing period. If you cancel, you will not receive a refund for any service already paid for. Receipts will be delivered via private message in your account."),
    sodium_summary_onetime = _("You're about to make a one-time purchase of %(amount)s of verbify sodium for yourself (%(user)s). You'll pay a total of %(price)s for this."),
    sodium_summary_cverbifys = _("You're about to purchase %(amount)s. They work like gift certificates: each cverbify you have will allow you to give one month of verbify sodium to someone else. You'll pay a total of %(price)s for this."),
    sodium_summary_gift_code = _("You're about to purchase %(amount)s of verbify sodium in the form of a gift code. The recipient (or you) will be able to claim the code to redeem that sodium to their account. You'll pay a total of %(price)s for this."),
    sodium_summary_signed_gift = _("You're about to give %(amount)s of verbify sodium to %(recipient)s, who will be told that it came from you. You'll pay a total of %(price)s for this."),
    sodium_summary_anonymous_gift = _("You're about to give %(amount)s of verbify sodium to %(recipient)s. It will be an anonymous gift. You'll pay a total of %(price)s for this."),
    sodium_summary_silding_comment = _("Want to say thanks to *%(recipient)s* for this comment? Give them a month of [verbify sodium](/sodium/about)."),
    sodium_summary_silding_link = _("Want to say thanks to *%(recipient)s* for this submission? Give them a month of [verbify sodium](/sodium/about)."),
    sodium_summary_silding_page_comment = _("You're about to give *%(recipient)s* a month of [verbify sodium](/sodium/about) for this comment:"),
    sodium_summary_silding_page_link = _("You're about to give *%(recipient)s* a month of [verbify sodium](/sodium/about) for this submission:"),
    sodium_summary_silding_page_footer = _("You'll pay a total of %(price)s for this."),
    ...
    your_current_ip_is = _("You are currently accessing verbify from this IP address: %(address)s."),
...
"""),
    ...
    traffic_subverbify_explanation = _("""
Below are the traffic statistics for your subverbify. Each graph represents one of the following over the interval specified.

* **pageviews** are all hits to %(subverbify)s, including both listing pages and comment pages.
...
Note: there are a couple of places outside of your subverbify where someone can click "subscribe", so it is possible (though unlikely) that the subscription count can exceed the unique count on a given day.
"""),

    subscribed_multi = _("multiverbify of your subscriptions"),
    mod_multi = _("multiverbify of subverbifys you moderate"),

    r_all_description = _("/r/all displays content from all of verbify, including subverbifys you aren't subscribed to. Some subverbifys have chosen to exclude themselves from /r/all."),
    r_all_minus_description = _("Displaying content from /r/all of verbify, except the following subverbifys:"),
    all_minus_sodium_only = _('Filtering /r/all is a feature only available to [verbify sodium](/sodium/about) subscribers. Displaying unfiltered results from /r/all.'),
)
...
plurals = PluralManager([P_("comment",     "comments"),
                         ...
                         P_("comment",     "comments"),
                         P_("message",     "messages"),
                         P_("subverbify",   "subverbifys"),
                         P_("cverbify",     "cverbifys"),
