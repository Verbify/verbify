...
from v1.lib.db.thing import Thing, NotFound
from v1.lib.memoize import memoize
from v1.lib.utils import Enum, to_date, tup
from v1.models.account import Account
from v1.models import Link, Frontpage
...
class PromotionWeights(Sessionized, Base):
    ...
    def add(cls, link, campaign):
        ...
        sr_names = campaign.target.subverbify_names
