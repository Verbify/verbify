...
from v1.lib.db.thing import Relation, MultiRelation
from v1.lib.utils import tup
from v1.models import Link, Comment, Message, Subverbify, Account
...
_SubverbifyReport = Relation(Account, Subverbify)
_MessageReport = Relation(Account, Message)
REPORT_RELS = (_LinkReport, _CommentReport, _SubverbifyReport, _MessageReport)
...
_SubverbifyReport._cache_prefix = classmethod(lambda cls: "reportsr:")
