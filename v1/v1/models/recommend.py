...
from v1.lib.db.tdb_cassandra import max_column_count
from v1.lib.utils import utils, tup
from v1.models import Account, LabeledMulti, Subverbify
...
class AccountSRPrefs(object):
    ...
    multiverbifys, and recent interactions with the recommender UI.

    Likes are used to generate recommendations, dislikes to filter out
    unwanted results, and recent views to make sure the same subverbifys aren't
    ...
    def for_user(cls, account):
        ...
        subscriptions = Subverbify.user_subverbifys(account, limit=None)
