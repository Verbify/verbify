...
from v1.lib.utils import Enum, tup
...
class EmailHandler(object):
    ...
    def from_queue(self, max_date, batch_limit = 50, kind = None):
        from v1.models import Account, Thing
        keep_trying = True
        min_id = None
        s = self.queue_table
        while keep_trying:
...
class Email(object):
    ...
    subjects = {
        Kind.SHARE : _("[verbify] %(user)s has shared a link with you"),
        Kind.FEEDBACK : _("[feedback] feedback from '%(user)s'"),
        Kind.ADVERTISE :  _("[advertising] feedback from '%(user)s'"),
        Kind.OPTOUT : _("[verbify] email removal notice"),
        Kind.OPTIN  : _("[verbify] email addition notice"),
        Kind.RESET_PASSWORD : _("[verbify] reset your password"),
        Kind.VERIFY_EMAIL : _("[verbify] verify your email address"),
        Kind.BID_PROMO : _("[verbify] your budget has been accepted"),
        Kind.ACCEPT_PROMO : _("[verbify] your promotion has been accepted"),
        Kind.REJECT_PROMO : _("[verbify] your promotion has been rejected"),
        Kind.QUEUED_PROMO : _("[verbify] your promotion has been charged"),
        Kind.LIVE_PROMO   : _("[verbify] your promotion is now live"),
        Kind.FINISHED_PROMO : _("[verbify] your promotion has finished"),
        Kind.NEW_PROMO : _("[verbify] your promotion has been created"),
        Kind.EDITED_LIVE_PROMO : _("[verbify] your promotion edit is being approved"),
        Kind.NERDMAIL : _("[verbify] hey, nerd!"),
        Kind.SODIUMMAIL : _("[verbify] verbify sodium activation link"),
        Kind.PASSWORD_CHANGE : _("[verbify] your password has been changed"),
        Kind.EMAIL_CHANGE : _("[verbify] your email address has been changed"),
        Kind.REFUNDED_PROMO: _("[verbify] your campaign didn't get enough impressions"),
        Kind.VOID_PAYMENT: _("[verbify] your payment has been voided"),
        Kind.SODIUM_GIFT_CODE: _("[verbify] your verbify sodium gift code"),
        ...
        Kind.MESSAGE_NOTIFICATION: _("[verbify] message notification"),
        Kind.ADS_ALERT: _("[verbify] Ads Alert"),
        }
    ...
    def to_MIMEText(self):
        ...
        if not fr.startswith('-') and not self.to_addr.startswith('-'):
            ...
            if self.user:
                msg['X-Verbify-username'] = utf8(self.user.name)
            msg['X-Verbify-ID'] = self.msg_hash
            if self.reply_to:
                msg['Reply-To'] = utf8(self.reply_to)
            return msg
        return None

@memoize('v1.models.mail_queue.has_opted_out')
...
@memoize('v1.models.mail_queue.opt_count')
def opt_count():
    o = Email.handler.opt_table
