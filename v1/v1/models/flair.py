...
from v1.lib.db.thing import Relation
from v1.lib.db.userrel import UserRel
from v1.lib.utils import to36
...
class Flair(Relation(Subverbify, Account)):
    _cache = g.thingcache
...
class FlairTemplateBySubverbifyIndex(tdb_cassandra.Thing):
    """Lists of FlairTemplate IDs for a subverbify.
    ...
    flair templates within the subverbify.
    """
