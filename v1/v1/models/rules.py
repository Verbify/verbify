...
MAX_RULES_PER_SUBVERBIFY = 10


class SubverbifyRules(tdb_cassandra.View):
    _use_db = True
    ...
    @classmethod
    def remove_rule(self, subverbify, short_name):
        """Remove a rule and update priorities of remaining rules."""
        self._remove(subverbify._id36, [short_name])

        rules = self.get_rules(subverbify)
        blobs = {}
        ...
        self._set_values(subverbify._id36, blobs)

    @classmethod
    def update(self, subverbify, old_short_name, short_name, description,
            kind=None):
    ...
    @classmethod
    def reorder(self, subverbify, short_name, priority):
        ...
        """
        rule_to_reorder = self.get_rule(subverbify, short_name)
