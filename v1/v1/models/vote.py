...
from v1.lib.db.tdb_cassandra import (
    ASCII_TYPE,
    UTF8_TYPE,
)
from v1.lib.utils import Enum, epoch_timestamp
...
class LinkVotesByAccount(VotesByAccount):
    ...
    # this is taken care of in v1.lib.voting:cast_vote
