...
from v1.lib.merge import *
from v1.models.last_modified import LastModified
from pycassa.system_manager import TIME_UUID_TYPE
from pylons import tmpl_context as c
from pylons import app_globals as g
from pylons.controllers.util import abort
from v1.lib.db.tdb_cassandra import NotFound
from v1.models.printable import Printable
...
restricted_namespaces = ('verbify/', 'config/', 'special/')
...
# Pages that get created automatically from the subverbify settings page
...
modactions = {
    ...
    "config/description": "Updated subverbify description",
    "config/sidebar": "Updated subverbify sidebar",
    "config/submit_text": "Updated submission text",
}

# Page "index" in the subverbify "verbify.com" and a seperator of "\t" becomes:
#   "verbify.com\tindex"
def wiki_id(sr, page):
...
class WikiPage(tdb_cassandra.Thing):
    """ Contains permissions, current content (markdown), subverbify, and current revision (ID)
        Key is subverbify-pagename """
...
class WikiPagesBySR(tdb_cassandra.DenormalizedView):
    """ Associate revisions with subverbifys, store only recent """
    _use_db = True
    _connection_pool = 'main'
    _view_of = WikiPage
