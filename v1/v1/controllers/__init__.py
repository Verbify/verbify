...
_verbify_controllers = {}
_plugin_controllers = {}

def get_controller(name):
    name = name.lower() + 'controller'
    if name in _verbify_controllers:
        return _verbify_controllers[name]
...
def load_controllers():
    ...
    from listingcontroller import VerbifysController
    ...
    from listingcontroller import SildedController

    from listingcontroller import MyverbifysController
    ...
    from apiv1.sodium import APIv1SodiumController
    ...
    from ipn import VerbifyGiftsController
    from mailgun import MailgunWebhookController

    _verbify_controllers.update((name.lower(), obj) for name, obj in locals().iteritems())
