...
from v1.lib.pages import BoringPage, ApiHelp
from v1.lib.validator import validate, VOneOf
...
class ApidocsController(VerbifyController):
    @staticmethod
    ...
    def GET_docs(self, mode):
        ...
        from v1.controllers.api import ApiController, ApiminimalController
        from v1.controllers.apiv1.user import APIv1UserController
        from v1.controllers.apiv1.sodium import APIv1SodiumController
        from v1.controllers.apiv1.scopes import APIv1ScopesController
        from v1.controllers.captcha import CaptchaController
        from v1.controllers.front import FrontController
        from v1.controllers.wiki import WikiApiController, WikiController
        from v1.controllers.multi import MultiApiController
        from v1.controllers import listingcontroller

        api_controllers = [
            (APIv1UserController, '/api/v1'),
            (APIv1SodiumController, '/api/v1'),
