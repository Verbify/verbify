...
from verbify_base import VerbifyController, UnloggedUser
from v1.lib.pages import (ButtonLite, ButtonDemoPanel, WidgetDemoPanel,
                          BoringPage)
...
class ButtonsController(VerbifyController):
    def get_wrapped_link(self, url, link = None, wrapper = None):
        try:
            ...
            if link:
                ...
                sr = None if isinstance(c.site, FakeSubverbify) else c.site
                try:
            ...
            # link(s) is/are members of a private verbify
    ...
    def GET_button_demo_page(self):
        ...
        return BoringPage(_("verbify buttons"),
                          show_sidebar = False, 
                          content=ButtonDemoPanel()).render()

    def GET_widget_demo_page(self):
        return BoringPage(_("verbify widget"),
                          show_sidebar = False, 
