...
from verbify_base import VerbifyController
from v1.controllers.oauth2 import require_oauth2_scope
from v1.lib.utils import url_links_builder
from verbify_base import paginated_listing
from v1.models.wiki import (
    ContentLengthError,
    modactions,
    WikiPage,
    WikiPageExists,
...
from v1.models.builder import WikiRevisionBuilder, WikiRecentRevisionBuilder

from v1.lib.template_helpers import join_urls
...
from v1.lib.validator.wiki import (
    VWikiPage,
    VWikiPageAndVersion,
    VWikiModerator,
    VWikiPageRevise,
...
from v1.lib.pages.wiki import (WikiPageView, WikiNotFound, WikiRevisions,
                              WikiEdit, WikiSettings, WikiRecent,
                              WikiListing, WikiDiscussions,
                              WikiCreate)

from v1.config.extensions import set_extension
from v1.lib.template_helpers import add_sr
from v1.lib.db import tdb_cassandra
from v1.models.listing import WikiRevisionListing
from v1.lib.pages.things import default_thing_wrapper
from v1.lib.pages import BoringPage, CssError
from verbify_base import base_listing
from v1.models import IDBuilder, LinkListing, DefaultSR
from v1.lib.merge import ConflictException, make_htmldiff
from pylons.i18n import _
from v1.lib.pages import PaneStack
from v1.lib.utils import timesince
from v1.config import extensions
from v1.lib.base import abort
from v1.lib.errors import verbify_http_error
from v1.lib.automoderator import Ruleset

import json

page_descriptions = {
    "config/stylesheet": _("This page is the subverbify stylesheet, changes here apply to the subverbify css"),
    "config/submit_text": _("The contents of this page appear on the submit page"),
    "config/sidebar": _("The contents of this page appear on the subverbify sidebar"),
    "config/description": _("The contents of this page appear in the public subverbify description and when the user does not have access to the subverbify"),
    "config/automoderator": _("This page is used to configure AutoModerator for the subverbify, please see [the full documentation](/wiki/automoderator/full-documentation) for information"),
}
...
RENDERERS_BY_PAGE = {
    ...
    "config/description": "verbify",
    "config/sidebar": "verbify",
    "config/stylesheet": "stylesheet",
    "config/submit_text": "verbify",
    "toolbox": "rawcode",
    "usernotes": "rawcode",
}

class WikiController(VerbifyController):
    ...
    def GET_wiki_create(self, wp, page):
        ...
        if wp[0]:
            ...
            if error['reason'] == 'PAGE_NAME_LENGTH':
                ...
                error_msg = _("this page is a special page, please go into the subverbify settings and save the field once to create this special page")
    ...
    def GET_wiki_recent(self, num, after, reverse, count):
        """Retrieve a list of recently changed wiki pages in this subverbify"""
    ...
    def GET_wiki_listing(self):
        """Retrieve a list of wiki pages in this subverbify"""
    ...
    def on_validation_error(self, error):
        VerbifyController.on_validation_error(self, error)
        if error.code:
