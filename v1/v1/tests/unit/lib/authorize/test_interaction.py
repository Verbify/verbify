...
from v1.lib.authorize.api import (AuthorizationHoldNotFound,
                                  DuplicateTransactionError,
                                  TRANSACTION_NOT_FOUND,
                                  TransactionError,)
from v1.lib.authorize.interaction import (get_or_create_customer_profile,
                                          add_payment_method,
...
from v1.models import Account, Link
from v1.tests import VerbifyTestCase


class InteractionTest(VerbifyTestCase):
    ...
    @patch('v1.lib.authorize.interaction.api.get_customer_profile')
    @patch('v1.lib.authorize.interaction.api.create_customer_profile')
    def test_get_or_create_customer_profile(self, create_customer_profile,
        ...
        with patch('v1.lib.authorize.interaction.CustomerID.get_id') as get_id:
    ...
    @patch('v1.lib.authorize.interaction.PayID.add')
    @patch('v1.lib.authorize.interaction.api.create_payment_profile')
    @patch('v1.lib.authorize.interaction.CustomerID.get_id')
    ...
    @patch('v1.lib.authorize.interaction.api.update_payment_profile')
    ...
    @patch('v1.lib.authorize.interaction.PayID.delete')
    @patch('v1.lib.authorize.interaction.api.delete_payment_profile')
    ...
    @patch('v1.lib.authorize.interaction.add_payment_method')
    @patch('v1.lib.authorize.interaction.update_payment_method')
    ...
    @patch('v1.lib.authorize.interaction.Bid._new')
    ...
    @patch('v1.lib.authorize.interaction.request')
    @patch('v1.lib.authorize.interaction.api.create_authorization_hold')
    @patch('v1.lib.authorize.interaction.CustomerID.get_id')
    @patch('v1.lib.authorize.interaction.PayID.get_ids')
    def test_auth_transaction(self, get_ids, get_id, create_authorization_hold,
        ...
        with patch('v1.lib.authorize.interaction.Bid._new') as _new:
            return_value = auth_transaction(amount, self.user,
                                            payment_method_id, link,
                                            campaign_id)
            self.assertTrue(_new.called)
    ...
    @patch('v1.lib.authorize.interaction.api.capture_authorization_hold')
    @patch('v1.lib.authorize.interaction.Bid.one')
    ...
    def test_void_transaction(self, one):
        ...
        with patch('v1.lib.authorize.interaction.api.void_authorization_hold') as void:
    ...
    def test_refund_transaction(self, one):
        ...
        with patch('v1.lib.authorize.interaction.api.refund_transaction') as refund:
