...
from v1.lib.authorize.api import (TRANSACTION_NOT_FOUND,
                                  TRANSACTION_ERROR,
...
class AuthorizeNetExceptionTest(VerbifyTestCase):
...
class SimpleXMLObjectTest(VerbifyTestCase):

    def setUp(self):
        from v1.lib.authorize.api import SimpleXMLObject
    ...
    def test_address(self):
        from v1.lib.authorize import Address
    ...
    def test_credit_card(self):
        from v1.lib.authorize import CreditCard
    ...
    def test_payment_profile(self):
        from v1.lib.authorize.api import PaymentProfile
    ...
    def test_transaction(self):
        from v1.lib.authorize.api import Transaction
...
class ApiFunctionTest(TestCase):
    ...
    @patch('v1.lib.authorize.api.CreateCustomerProfileRequest')
    @patch('v1.lib.authorize.api.Profile')
    ...
    @patch('v1.lib.authorize.api.GetCustomerProfileRequest')
    ...
    @patch('v1.lib.authorize.api.CreateCustomerPaymentProfileRequest')
    @patch('v1.lib.authorize.api.PaymentProfile')
    ...
    @patch('v1.lib.authorize.api.UpdateCustomerPaymentProfileRequest')
    @patch('v1.lib.authorize.api.PaymentProfile')
    ...
    @patch('v1.lib.authorize.api.DeleteCustomerPaymentProfileRequest')
    ...
    @patch('v1.lib.authorize.api.CreateCustomerProfileTransactionRequest')
