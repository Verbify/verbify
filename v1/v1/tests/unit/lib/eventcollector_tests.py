...
class TestEventCollector(VerbifyTestCase):
        ...
        self.amqp.assert_event_item(
            dict(
                ...
                payload={
                    ...
                    'sr_id': initial_vote.thing.subverbify_slow._id,
                    'sr_name': initial_vote.thing.subverbify_slow.name,
        ...
        self.amqp.assert_event_item(
            dict(
                ...
                payload={
                    ...
                    'sr_id': upvote.thing.subverbify_slow._id,
                    'sr_name': upvote.thing.subverbify_slow.name,
        ...
        self.amqp.assert_event_item(
            dict(
                ...
                payload={
                    ...
                    'sr_id': new_link.subverbify_slow._id,
                    'sr_name': new_link.subverbify_slow.name,
    ...
    def test_mod_event(self):
        ...
        subverbify = MagicMock(name="subverbify")
        context = MagicMock(name="context")
        request = MagicMock(name="request")
        request.ip = "1.2.3.4"
        g.events.mod_event(
            modaction, subverbify, mod, context=context, request=request
        )
        ...
        self.amqp.assert_event_item(
            {
                ...
                'payload': {
                    'sr_id': subverbify._id,
                    'sr_name': subverbify.name,
                    'domain': request.host,
                    'user_agent': request.user_agent,
                    'user_agent_parsed': request.parsed_agent.to_dict(),
                    'referrer_url': request.headers.get(),
    ...
    def test_quarantine_event(self):
        ...
        g.events.quarantine_event(
            event_type, subverbify, context=context, request=request
        )
        ...
        self.amqp.assert_event_item(
            {
                ...
                "payload": {
                    ...
                    'user_agent': request.user_agent,
                    'user_agent_parsed': request.parsed_agent.to_dict(),
                    'sr_id': message.subverbify_slow._id,
                    'sr_name': message.subverbify_slow.name,
                    'oauth2_client_id': context.oauth2_client._id,
                    'oauth2_client_app_type': context.oauth2_client.app_type,
                    'oauth2_client_name': context.oauth2_client.name,
                    'geoip_country': context.location,
