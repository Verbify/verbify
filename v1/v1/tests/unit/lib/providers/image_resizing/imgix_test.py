...
from v1.lib.providers.image_resizing import NotLargeEnough
from v1.lib.providers.image_resizing.imgix import ImgixImageResizingProvider
...
class TestImgixResizer(VerbifyTestCase):
    def setUp(self):
