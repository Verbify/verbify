...
class TestThingReadCaching(VerbifyTestCase):
    def setUp(self):
...
class TestThingWrite(VerbifyTestCase):
    def setUp(self):
        self.lock = FakeLock()
        self.thing_id = 333
...
class TestThingIncr(VerbifyTestCase):
    def setUp(self):
        self.lock = FakeLock()
        self.thing_id = 333
    ...
    @patch("v1.lib.db.tdb_sql.incr_thing_prop")
    ...
    @patch("v1.lib.db.tdb_sql.incr_thing_data")
    ...
    @patch("v1.lib.db.tdb_sql.set_thing_data")
...
class TestThingWriteConflict(VerbifyTestCase):
    def setUp(self):
        self.lock = FakeLock()
        self.thing_id = 333
    ...
    @patch("v1.lib.db.thing.Thing.get_things_from_cache")
    ...
    @patch("v1.lib.db.thing.Thing.get_read_modify_write_lock")
    ...
    @patch("v1.lib.db.thing.Thing.write_new_thing_to_db")
    ...
    @patch("v1.lib.db.thing.Thing.write_changes_to_db")
