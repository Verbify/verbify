...
from v1.models import Collection, CollectionStorage
from v1.tests import VerbifyTestCase


class CollectionStorageTest(VerbifyTestCase):
...
class CollectionTest(VerbifyTestCase):
...
class CollectionOrderTest(VerbifyTestCase):
    """
