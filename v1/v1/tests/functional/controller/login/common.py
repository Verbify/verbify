...
from v1.lib.validator import VThrottledLogin, VUname, validator
from v1.models import Account, NotFound
...
class LoginRegBase(object):
    ...
    but rather should be added as a mixin on a VerbifyControllerTestCase
    ...
    which use v1.lib.controlers.login as part of the flow.
    """
    ...
    def mock_register(self):
        ...
        """
        from v1.controllers import login
