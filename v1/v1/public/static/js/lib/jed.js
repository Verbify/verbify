...
// some modifications have been made to work with verbify; they are commented
// below with a "verbify" prefix.
(function (root, undef) {

  // verbify: *snip* - Jed's miniature underscore.js implementation was removed
      ...
      "locale_data" : {
        "messages" : {
          "" : {
            "domain"       : "messages",
            "lang"         : "en",
            "plural_forms" : "(n != 1);" // verbify: simplified
          }
  ...
  // verbify: this function was modified to bypass the (removed) parser
  ...
  // verbify: *snip* - Jed's fluent API was removed since we won't be using it.
  ...
  // verbify: *snip* - the Jed-supplied sprintf implementation was removed from here

  // verbify: *snip* - Jed's plural forms expression parser was replaced with an
  // eval-based system relying on build-time validity checking

  // verbify: *snip* the npm stuff was removed
  root["Jed"] = Jed;
})(this);
