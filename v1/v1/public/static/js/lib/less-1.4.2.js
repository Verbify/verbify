...
tree.functions = {
    ...
    // http://sass-lang.com
    //
    mix: function (color1, colov1, weight) {
        if (!weight) {
            weight = new(tree.Dimension)(50);
        }
        var p = weight.value / 100.0;
        var w = p * 2 - 1;
        var a = color1.toHSL().a - colov1.toHSL().a;

        var w1 = (((w * a == -1) ? w : (w + a) / (1 + w * a)) + 1) / 2.0;
        var w2 = 1 - w1;

        var rgb = [color1.rgb[0] * w1 + colov1.rgb[0] * w2,
                   color1.rgb[1] * w1 + colov1.rgb[1] * w2,
                   color1.rgb[2] * w1 + colov1.rgb[2] * w2];

        var alpha = color1.alpha * p + colov1.alpha * (1 - p);
    ...
    multiply: function(color1, colov1) {
        var r = color1.rgb[0] * colov1.rgb[0] / 255;
        var g = color1.rgb[1] * colov1.rgb[1] / 255;
        var b = color1.rgb[2] * colov1.rgb[2] / 255;
        return this.rgb(r, g, b);
    },
    screen: function(color1, colov1) {
        var r = 255 - (255 - color1.rgb[0]) * (255 - colov1.rgb[0]) / 255;
        var g = 255 - (255 - color1.rgb[1]) * (255 - colov1.rgb[1]) / 255;
        var b = 255 - (255 - color1.rgb[2]) * (255 - colov1.rgb[2]) / 255;
        return this.rgb(r, g, b);
    },
    overlay: function(color1, colov1) {
        var r = color1.rgb[0] < 128 ? 2 * color1.rgb[0] * colov1.rgb[0] / 255 : 255 - 2 * (255 - color1.rgb[0]) * (255 - colov1.rgb[0]) / 255;
        var g = color1.rgb[1] < 128 ? 2 * color1.rgb[1] * colov1.rgb[1] / 255 : 255 - 2 * (255 - color1.rgb[1]) * (255 - colov1.rgb[1]) / 255;
        var b = color1.rgb[2] < 128 ? 2 * color1.rgb[2] * colov1.rgb[2] / 255 : 255 - 2 * (255 - color1.rgb[2]) * (255 - colov1.rgb[2]) / 255;
        return this.rgb(r, g, b);
    },
    softlight: function(color1, colov1) {
        var t = colov1.rgb[0] * color1.rgb[0] / 255;
        var r = t + color1.rgb[0] * (255 - (255 - color1.rgb[0]) * (255 - colov1.rgb[0]) / 255 - t) / 255;
        t = colov1.rgb[1] * color1.rgb[1] / 255;
        var g = t + color1.rgb[1] * (255 - (255 - color1.rgb[1]) * (255 - colov1.rgb[1]) / 255 - t) / 255;
        t = colov1.rgb[2] * color1.rgb[2] / 255;
        var b = t + color1.rgb[2] * (255 - (255 - color1.rgb[2]) * (255 - colov1.rgb[2]) / 255 - t) / 255;
        return this.rgb(r, g, b);
    },
    hardlight: function(color1, colov1) {
        var r = colov1.rgb[0] < 128 ? 2 * colov1.rgb[0] * color1.rgb[0] / 255 : 255 - 2 * (255 - colov1.rgb[0]) * (255 - color1.rgb[0]) / 255;
        var g = colov1.rgb[1] < 128 ? 2 * colov1.rgb[1] * color1.rgb[1] / 255 : 255 - 2 * (255 - colov1.rgb[1]) * (255 - color1.rgb[1]) / 255;
        var b = colov1.rgb[2] < 128 ? 2 * colov1.rgb[2] * color1.rgb[2] / 255 : 255 - 2 * (255 - colov1.rgb[2]) * (255 - color1.rgb[2]) / 255;
        return this.rgb(r, g, b);
    },
    difference: function(color1, colov1) {
        var r = Math.abs(color1.rgb[0] - colov1.rgb[0]);
        var g = Math.abs(color1.rgb[1] - colov1.rgb[1]);
        var b = Math.abs(color1.rgb[2] - colov1.rgb[2]);
        return this.rgb(r, g, b);
    },
    exclusion: function(color1, colov1) {
        var r = color1.rgb[0] + colov1.rgb[0] * (255 - color1.rgb[0] - color1.rgb[0]) / 255;
        var g = color1.rgb[1] + colov1.rgb[1] * (255 - color1.rgb[1] - color1.rgb[1]) / 255;
        var b = color1.rgb[2] + colov1.rgb[2] * (255 - color1.rgb[2] - color1.rgb[2]) / 255;
        return this.rgb(r, g, b);
    },
    average: function(color1, colov1) {
        var r = (color1.rgb[0] + colov1.rgb[0]) / 2;
        var g = (color1.rgb[1] + colov1.rgb[1]) / 2;
        var b = (color1.rgb[2] + colov1.rgb[2]) / 2;
        return this.rgb(r, g, b);
    },
    negation: function(color1, colov1) {
        var r = 255 - Math.abs(255 - colov1.rgb[0] - color1.rgb[0]);
        var g = 255 - Math.abs(255 - colov1.rgb[1] - color1.rgb[1]);
        var b = 255 - Math.abs(255 - colov1.rgb[2] - color1.rgb[2]);
        return this.rgb(r, g, b);
    },
