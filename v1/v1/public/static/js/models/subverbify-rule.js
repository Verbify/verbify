...
!function(models, Backbone, undefined) {
  ...
  var SubverbifyRule = Backbone.Model.extend({
  ...
  var SubverbifyRuleCollection = Backbone.Collection.extend({
    model: SubverbifyRule,
    maxLength: RULES_COLLECTION_MAX_LENGTH,
    subverbifyName: null,
    subverbifyFullname: null,

    initialize: function(models, options) {
      this._disabled = this.length >= this.maxLength;
      
      if (options && options.subverbifyName) {
        this.subverbifyName = options.subverbifyName;
      }
      if (options && options.subverbifyFullname) {
        this.subverbifyFullname = options.subverbifyFullname;
      }
  ...
  r.models.SubverbifyRule = SubverbifyRule;
  r.models.SubverbifyRuleCollection = SubverbifyRuleCollection;
}(r, Backbone);
