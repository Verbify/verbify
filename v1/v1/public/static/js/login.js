...
r.login.ui = {
    ...
    _getActionDetails: function(el) {
      ...
      if ($el.hasClass('up')) {
      ...
      } else if ($el.hasClass('give-sodium')) {
        return {
            eventName: 'give-sodium',
            description: r._('You need to be logged in to give sodium.')
        };
        ...
        return {
            ...
            description: r._('You need to be logged in to subscribe to subverbifys.')
        };
  ...
  _logEvent: function(e) {
      ...
      if (!targetFullname && targetType == 'subverbify') {
