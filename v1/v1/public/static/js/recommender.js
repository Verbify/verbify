...
/**
 * Example usage:
 * // generate recs for people who like book subverbifys
...
r.recommend.RecommendationList = Backbone.Collection.extend({
    ...
    // names of subverbifys for which recommendations are generated
    // (if user likes srNames, he will also like...)
    srNames: [],

    // names of subverbifys that should be excluded from future recs because
...
r.recommend.ExploreItem = Backbone.View.extend({
    events: {
        'click .explore-feedback-dismiss': 'dismissSubverbify',
        'click a': 'recordClick'
    },  

    dismissSubverbify: function(ev) {
