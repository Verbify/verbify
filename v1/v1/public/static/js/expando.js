!function(r) {
  ...
  var LinkExpando = Expando.extend({
    ...
    initialize: function() {
      ...
      if ('subverbify' in thingData) {
        eventData.subverbifyName = thingData.subverbify;
      }

      if ('subverbifyFullname' in thingData) {
        eventData.subverbifyFullname = thingData.subverbifyFullname;
      }
    ...
    show: function() {
      ...
      if (!this._expandoEventData.provider) {
        ...
        if ($media.is('iframe')) {
          ...
          this._expandoEventData.provider = 'verbify';
        }
      }
