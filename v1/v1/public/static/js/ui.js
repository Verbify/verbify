r.ui.init = function() {
    // welcome bar
    if ($.cookie('verbify_first')) {
        // save welcome seen state and delete obsolete cookie
        $.cookie('verbify_first', null, {domain: r.config.cur_domain})
    ...
    $('.submit_text').each(function(idx, el) {
        $(el).data('SubverbifySubmitText', new r.ui.SubverbifySubmitText({el: el}))
    })
...
r.ui.SubverbifySubmitText = Backbone.View.extend({
    initialize: function() {
